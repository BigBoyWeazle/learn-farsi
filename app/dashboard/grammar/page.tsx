  ...
  return (
    <div className="max-w-2xl mx-auto py-4 sm:py-8 px-2 sm:px-0">
      ...
      <Link
        ...
        className="block bg-white/40 backdrop-blur-lg border border-persian-gold-400/50 rounded-xl shadow-[0_4px_24px_rgba(0,0,0,0.06)] p-4 sm:p-5 mb-6 sm:mb-8 hover:shadow-[0_8px_32px_rgba(0,0,0,0.12)] hover:bg-white/50 transition-all ring-1 ring-white/20"
      >
        <div className="flex items-center justify-between">
      ...
      {lessons.length === 0 ? (
        <div className="bg-white/40 backdrop-blur-lg border border-persian-red-400/40 shadow-[0_8px_32px_rgba(0,0,0,0.08)] rounded-xl p-8 text-center ring-1 ring-white/20">
